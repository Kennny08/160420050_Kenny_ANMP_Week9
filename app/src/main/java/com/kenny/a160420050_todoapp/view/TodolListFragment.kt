...
import com.kenny.a160420050_todoapp.viewmodel.ListTodoViewModel

class TodolListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_todol_list, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fabAddTodo.setOnClickListener {
            val action = TodolListFragmentDirections.actionCreateTodo()
